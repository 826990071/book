...
-   强化石优先放<a style="color: blue;">不稳定的强化石</a>，若无，放其它强化石亦可
-   优先使用<a style="color: blue;">福格斯的忏悔值100%卷轴</a>，可代替AP消耗
...
> [!Attention|label:注意]>6级及以上附魔失败后会获得该附魔的<a style="color: green;">附魔碎片</a>×1，4个同样的<a style="color: green;">附魔碎片</a>可合成1个100%成功率的附魔
    
## 研磨
**研磨能提升装备的属性值，需要消耗金币和材料**
-   装备研磨的属性值到达上限，且装备强化至+13后，开放强化<a style="color: red;">攻击力限制解除</a>属性
